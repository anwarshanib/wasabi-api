...
<nav class="top-bar">
    <a href="/docs/guide" class="top-bar-brand">Wasabi <span>Card</span> API</a>
    <div class="top-bar-links">
        <a href="/docs/guide" class="link-ghost">Integration Guide</a>
        <a href="/api/documentation" target="_blank" class="link-primary">Swagger UI ↗</a>
    </div>
</nav>
